  ...
  return (
    <>
      ...
      >
        {/* Wallet Leather Base */}
        <div 
          className="relative w-64 h-36 bg-[#8c5035] rounded-lg shadow-[0_15px_30px_rgba(0,0,0,0.4)] border border-[#6b3c27]"
          style={{
        ...
        >
          {/* Leather Stitches */}
          <div className="absolute inset-[4px] border-[1px] border-dashed border-[#d4af37] opacity-60 rounded-md"></div>
          
          {/* Credit Card Sticking Out */}
          <div 
            className="absolute -top-6 left-8 w-44 h-24 bg-gradient-to-tr from-gray-900 to-gray-700 rounded-lg shadow-xl -z-10 group-hover:-translate-y-6 transition-transform duration-500 ease-out"
          >
          ...
          <div 
            className="absolute bottom-0 w-full h-24 bg-[#7d4831] rounded-b-lg border-t-[1.5px] border-[#4a2414] shadow-[0_-3px_12px_rgba(0,0,0,0.5)] overflow-hidden"
          >
             {/* Match Texture */}
             ...
             <div className="absolute inset-[4px] border-[1.5px] border-dashed border-[#d4af37] opacity-60 rounded-b-md border-t-0 z-10"></div>
                  ...
                  <div className="space-y-4 relative mt-auto pb-4">
                    ...
                    <div className="w-full bg-gradient-to-br from-[#1f2937]/90 to-[#111827]/90 backdrop-blur-md rounded-2xl p-6 shadow-[0_20px_40px_rgba(0,0,0,0.6)] border border-white/15 relative overflow-hidden group hover:scale-[1.02] hover:-translate-y-1 transition-all duration-300 cursor-pointer">
                      ...
                      <div className="flex justify-between items-start mb-8">
                        ...
                        <span className="font-serif italic font-bold text-[18px] opacity-80 tracking-wider">Finvasia</span>
                      </div>
                  ...
                  <div className="flex-1">
                    ...
                    <div className="space-y-3">
                      {[
                        ...
                        { title: 'Finvasia Cloud', amount: '-₹1,200', emoji: '☁️' }
                      ].map((tx, i) => (
